...
\newenvironment{overview}[1]{\begin{figure}[!ht]\def\mycaption{#1}\centering\begin{longtable}{|p{120mm}|}\hline}{\\ \hline\end{longtable}\caption{The relations matching \rel{\small\mycaption}.}\end{figure}}
