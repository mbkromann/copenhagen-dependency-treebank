...
\newenvironment{overview}[1]{\begin{figure}[!ht]\def\mycaption{#1}\centering\begin{longtable}{p{120mm}}}{\end{longtable}\vspace{-10mm}\caption{The relations matching \rel{\small\mycaption}.}\end{figure}}
