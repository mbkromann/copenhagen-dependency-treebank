...
\newenvironment{ldescription}{}{}
\newenvironment{overview}[1]{\begin{figure}[!h]\def\mycaption{#1}\centering\begin{tabular}{|p{120mm}|}\hline}{\\ \hline\end{tabular}\caption{The relations matching \rel{\small\mycaption}.}\end{figure}}
...
\def\subtypes#1{\par\footnotesize\noindent Subtypes: #1. }
\def\related#1{\par\footnotesize Related types: #1. }
\def\tparents#1{}
\def\cmdsummary#1#2#3{\footnotesize\phantom{.}#1#2: #3\newline}
\def\overviewfile#1{\input{#1}}

\def\mytab{\hspace{2mm}}
